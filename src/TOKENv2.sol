...
contract TOKENv2 is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20PermitUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function _update(address from, address to, uint256 value) internal virtual override {
        uint256 actual = value * 99 / 100;
        uint256 burned = value - actual;
        if (burned > 0) {
            _burn(from, burned);
        }
        super._update(from, to, actual);
    }
